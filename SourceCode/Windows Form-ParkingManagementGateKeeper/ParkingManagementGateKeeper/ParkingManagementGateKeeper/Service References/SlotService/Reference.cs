...
namespace ParkingManagementGateKeeper.SlotService {
    ...
    public interface ISlotService {
        ...
        ParkingManagementGateKeeper.SlotService.bookingResult bookSlot(string section, int floor, string type, int userid, string vehicleno, System.DateTime arrivaltime, System.DateTime exittime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISlotService/bookSlot", ReplyAction="http://tempuri.org/ISlotService/bookSlotResponse")]
        System.Threading.Tasks.Task<ParkingManagementGateKeeper.SlotService.bookingResult> bookSlotAsync(string section, int floor, string type, int userid, string vehicleno, System.DateTime arrivaltime, System.DateTime exittime);
        ...
        ParkingManagementGateKeeper.SlotService.exitResult exitVehicle(int bookingId, System.DateTime exitTime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISlotService/exitVehicle", ReplyAction="http://tempuri.org/ISlotService/exitVehicleResponse")]
        System.Threading.Tasks.Task<ParkingManagementGateKeeper.SlotService.exitResult> exitVehicleAsync(int bookingId, System.DateTime exitTime);
        ...
        ParkingManagementGateKeeper.SlotService.Booking[] showBookings(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISlotService/showBookings", ReplyAction="http://tempuri.org/ISlotService/showBookingsResponse")]
        System.Threading.Tasks.Task<ParkingManagementGateKeeper.SlotService.Booking[]> showBookingsAsync(int userId);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISlotServiceChannel : ParkingManagementGateKeeper.SlotService.ISlotService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SlotServiceClient : System.ServiceModel.ClientBase<ParkingManagementGateKeeper.SlotService.ISlotService>, ParkingManagementGateKeeper.SlotService.ISlotService {
        ...
        public ParkingManagementGateKeeper.SlotService.bookingResult bookSlot(string section, int floor, string type, int userid, string vehicleno, System.DateTime arrivaltime, System.DateTime exittime) {
            return base.Channel.bookSlot(section, floor, type, userid, vehicleno, arrivaltime, exittime);
        }
        
        public System.Threading.Tasks.Task<ParkingManagementGateKeeper.SlotService.bookingResult> bookSlotAsync(string section, int floor, string type, int userid, string vehicleno, System.DateTime arrivaltime, System.DateTime exittime) {
        ...
        public ParkingManagementGateKeeper.SlotService.exitResult exitVehicle(int bookingId, System.DateTime exitTime) {
            return base.Channel.exitVehicle(bookingId, exitTime);
        }
        
        public System.Threading.Tasks.Task<ParkingManagementGateKeeper.SlotService.exitResult> exitVehicleAsync(int bookingId, System.DateTime exitTime) {
        ...
        public ParkingManagementGateKeeper.SlotService.Booking[] showBookings(int userId) {
            return base.Channel.showBookings(userId);
        }
        
        public System.Threading.Tasks.Task<ParkingManagementGateKeeper.SlotService.Booking[]> showBookingsAsync(int userId) {
